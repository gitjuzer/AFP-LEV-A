...
class CurriculumRepository extends BaseRepository
{
    ...
    {
        $this->_dao = $factory->getCurriculumDao();
    }

    public function findById($id)
    {
        $this->setInstance(new Curriculum($this->_dao->findById($id)));
    }

    public function findByName($name)
    {
        $this->setInstance(new Curriculum($this->_dao->findByName($name)));
    }
